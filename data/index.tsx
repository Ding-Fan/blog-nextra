...
export const POSTS_DATA: Quote[] = [
  ...
  },
  {
    ...
    content: "The value of a college education is not the learning of many facts but the training of the mind to think",
    description: "",
    hidden: false,
  },
  {
  ...
  {
    author: "Albert Einstein",
    content: "Imagination is more important than knowledge. For knowledge is limited, whereas imagination embraces the entire world, stimulating progress, giving birth to evolution. It is, strictly speaking, a real factor in scientific research.",
    description: "",
    hidden: false,
  },
  {
