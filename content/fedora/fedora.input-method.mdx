...
Create `~/.config/environment.d/90-my-variables.conf`

```sh filename=~/.config/environment.d/90-my-variables.conf
# fix telegram crash
# fcitx5 has /etc/profile.d/fcitx5.sh to set env vars
# we should override it here instead of modifying that file
# and reboot
