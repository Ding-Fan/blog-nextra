...
- https://threejs-example-git-main-ding-fans-projects.vercel.app/xr-calendar

mobile browser might require https to access device orientation data, so localhost won't work.
