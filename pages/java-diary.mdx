...
public class ClayFigure {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Weight: " + clayFigureAomori.weight); // access the instance variable from the instance clayFigureAomori
        System.out.println("Height: " + ClayFigure.height); // access the class variable from the class ClayFigure
    }
