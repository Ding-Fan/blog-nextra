...
protected String name = "Clay Figure"; // protected: only the class and its subclasses can access it
int age = 3000; // default: only the class and the package can access it
```

To explain them, let's create a package.

```java copy
public class ClayFigure {

    private int weight = 1440;
    protected height = 34.2;
